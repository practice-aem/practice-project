 ...
 */
package com.transformation.transformationproject.core.models;
...
import com.transformation.transformationproject.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "transformation/components/helloworld");
